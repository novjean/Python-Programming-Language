...
import sys #provides access to system variables used or maintained by the interpreter

print 'Creating BFS starting input for character ' + sys.argv[1] #argv is the argument vector, command-line arguments passed to the script 
